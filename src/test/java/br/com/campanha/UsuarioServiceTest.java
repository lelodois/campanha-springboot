...
public class UsuarioServiceTest extends BaseServiceMockTest {
	...
	public void putNewUsuarioSuccessTest() {
		...
		Result<UsuarioMessage> putNewUsuario = usuarioService.putNewUsuario(message);
	...
	public void putUpdateUsuarioSuccessTest() {
		...
		Result<UsuarioMessage> putNewUsuario = usuarioService.putUpdateUsuario(newUsuario);
		Assert.assertTrue(putNewUsuario.isSuccess());
	}

	private UsuarioMessage getUsuarioMessage(Result<UsuarioMessage> putNewUsuario) {
