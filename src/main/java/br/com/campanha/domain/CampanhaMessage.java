...
@ApiModel(description = "Modelo Campanha")
public class CampanhaMessage implements Serializable {
	...
	@ApiModelProperty(example = "01/09/2018", allowableValues = "Data string no formato dd/MM/yyyy", required = true)
	private String inicioVigencia;

	@ApiModelProperty(example = "10/09/2018", allowableValues = "Data string no formato dd/MM/yyyy", required = true)
